...
import { BabylonSceneService, ScreenMarker } from '../services/babylon-scene.service';
...
export class Map3dContainerComponent implements AfterViewInit, OnDestroy {
  ...
  private isSedeModel(modelName: string | null | undefined): boolean {
    return !!modelName && (
      modelName === this.sedeModel ||
      modelName === this.legacySedeModel ||
      modelName === this.oldSedeModel
    );
  }
